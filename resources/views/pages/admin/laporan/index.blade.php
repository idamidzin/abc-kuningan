			...
			<div class="card">
				<div class="card-body" id="card-body">
					<div class="card card-default">
						...
						<div class="card-body">
							<form id="form-laporan" target="_blank" action="{{ route('admin.laporan.cetak') }}" method="POST">
								@csrf
								<div class="form-row">
									<div class="col-sm-4">
										<select class="custom-select custom-select-sm" name="jenis">
											<option value="non-member">Booking</option>
									...
									<div class="col-auto">
										<button class="btn btn-purple mb-2" type="submit">Cetak Excel</button>
									</div>
								</div>
							</form>
						</div>
